...
Route::post('/tambahPelanggan', [Controller::class, 'tambahPelanggan']);
Route::delete('/deletepelanggan/{id_produk}', [Controller::class, 'deletePelanggan']);

Route::put('/updatepelanggan/{id}', [Controller::class, 'updatepelanggan']);
